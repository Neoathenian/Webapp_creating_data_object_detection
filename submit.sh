...
export SERVICE_NAME=${SERVICE_NAME:-object-detection-data-webapp}
...
export CACHE_IMAGE_NAME=${CACHE_IMAGE_NAME:-object-detection-data-webapp-cache}
...
SECRET_NAMES=${SECRET_NAMES:-"STRIPE_SECRET_KEY STRIPE_PRICE_ID_STARTER STRIPE_PRICE_ID_MEDIUM STRIPE_PRICE_ID_PRO STRIPE_WEBHOOK_SECRET GOOGLE_APPLICATION_CREDENTIALS GOOGLE_CLOUD_PROJECT INSTANCE_CONNECTION_NAME DB_NAME DB_USER DB_PASS CREDITS_PER_CENT ENV SESSION_SECRET"}
